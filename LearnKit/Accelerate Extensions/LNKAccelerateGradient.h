...
extern void LNK_learntheta_gd(LNKDesignMatrix *designMatrix, LNKFloat *thetaVector, LNKOptimizationAlgorithmGradientDescent *algorithm, LNKCostFunction costFunction);
...
extern void LNK_learntheta_lbfgs(LNKDesignMatrix *designMatrix, LNKFloat *thetaVector, BOOL regularizationEnabled, LNKFloat lambda, LNKHFunction hFunction, LNKCostFunction costFunction);
